...
public class Server implements Runnable {
	...
	public void run() {
		...
		while (!s.isClosed()) {
			...
			t = new ServerSocketThread(socketClient, this, sstO);
	...
	public void SendTo(String mesaj, String name) {
		if (sockets != null) {
			for (ServerSocketThread t : sockets) {
				if (t.getMyName().equalsIgnoreCase(name)) {
					t.send(mesaj);
				}
			}
		}
