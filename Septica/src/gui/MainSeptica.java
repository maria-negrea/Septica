...
public class MainSeptica extends JFrame {
	...
	private void addContainerListener(WindowAdapter windowAdapter) {
	...
	public void initializePanelCenter() {
		...
		panelCenter.setBorder(new MatteBorder(3, 2, 1, 3, (Color) new Color(51,
				51, 51)));
		...
		lblTopPlayerCard = new MyLabel(new ImageIcon(
				MainSeptica.class.getResource("/Images/10InimaNeagra.jpg")));
		...
		lblLeftPlayerCard = new MyLabel(new ImageIcon(
				MainSeptica.class.getResource("/Images/10InimaNeagra.jpg")));
		lblLeftPlayerCard.setPreferredSize(new Dimension(50, 70));
		panel_1.add(lblLeftPlayerCard);

		JPanel panel_2 = new JPanel();
		panel_2.setBorder(new SoftBevelBorder(BevelBorder.RAISED, new Color(51,
				0, 51), new Color(102, 204, 102), new Color(51, 204, 153),
				new Color(0, 51, 0)));
		...
		MyLabel lblDeck = new MyLabel(new ImageIcon(
				MainSeptica.class.getResource("/Images/imagesDeckRotated.jpg")));
		...
		lblRightPlayerCard = new MyLabel(new ImageIcon(
				MainSeptica.class.getResource("/Images/10InimaNeagra.jpg")));
		...
		lblCurrentPlayerCard = new MyLabel(new ImageIcon(
				MainSeptica.class.getResource("/Images/10InimaNeagra.jpg")));
